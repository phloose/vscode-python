...
import { DataflowAnalyzer, IRef, RefSet } from './data-flow';
...
export class CellProgram {
    ...
    private readonly defs: IRef[] | undefined;
    private readonly uses: IRef[] | undefined;
    /**
    ...
    public usesSomethingFrom(that: CellProgram) {
        if (this.uses) {
            const defs: IRef[] = that.defs ? that.defs : [];
