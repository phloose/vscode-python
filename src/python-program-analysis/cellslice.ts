...
export class CellSlice {
    private readonly cell: IAnalysisCell;
    private _slice: LocationSet;
    /**
     * Construct an instance of a cell slice.
     */
    constructor(cell: IAnalysisCell, slice: LocationSet) {
        this.cell = cell;
        this._slice = slice;
    }
    ...
    private getTextSlice(fullLines: boolean): string {
        const sliceLocations = this.slice.items;
        const textLines = this.cell.text.split('\n');
