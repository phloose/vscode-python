...
// The following code replaces the auto-generated lex function, which is defined recursively
// and crashes with stack overflow in many cases.
// DO NOT replace the function with fat arrow, since we need the traditional
// javascript interpretation of "this".
parser.__proto__.lexer.lex = function () {
    var r = this.next();
    while (!r) { r = this.next(); }
    return r;
};
