...
describe('CellSlice', () => {
    it('yields a text slice based on a set of locations', () => {
        let cellSlice = new CellSlice(
            { cell: new TestCell(['a = 1', 'b = 2', 'c = 3', 'd = 4', ''].join('\n'), 1), slice: new LocationSet({ first_line: 1, first_column: 0, last_line: 1, last_column: 5 }, { first_line: 2, first_column: 4, last_line: 3, last_column: 4 }) });
