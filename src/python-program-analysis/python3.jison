...
// strings
stringprefix            [rR]|[uU]|[fF]|[fF][rR]|[rR][fF]
...
// We throw away the byte or string prefix since we don't need it.
<INITIAL,INLINE>{bytesprefix}{tripledquote}  %{
                            tripleString = "";
                            this.begin( 'TRIPLE_D' )
                        %}
<INITIAL,INLINE>{stringprefix}?{tripledquote}  %{
                            tripleString = "";
                            this.begin( 'TRIPLE_D' )
                        %}
<TRIPLE_D>{tripledquote} %{
                        ...
                        %}
<TRIPLE_D>\n            tripleString += "\n";
<TRIPLE_D>{escapeseq}   tripleString += yytext;
<TRIPLE_D>.             tripleString += yytext;

<INITIAL,INLINE>{bytesprefix}{triplesquote}  %{
                            tripleString = "";
                            this.begin( 'TRIPLE_S' )
                        %}
<INITIAL,INLINE>{stringprefix}?{triplesquote}  %{
                            tripleString = "";
                            this.begin( 'TRIPLE_S' )
                        %}
<TRIPLE_S>{triplesquote} %{
                        ...
                        %}
<TRIPLE_S>\n            tripleString += "\n";
<TRIPLE_S>{escapeseq}   tripleString += yytext;
